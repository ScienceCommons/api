  ...
  describe "update_articles" do
    ...
    it "should not create an article if the doi already exists" do
      VCR.use_cassette('plos_alm') do
        ...
        Article.create(doi: '10.1371/journal.pone.0055903', title: 'Fake Title')
    ...
    it "should create an article with the appropriate fields" do
      VCR.use_cassette('plos_alm') do
        ...
        Article.find_by_doi('10.1371/journal.pone.0055903').destroy # destroy one article.

        expect(Article).to receive(:create).
          with({
            title: "Pleiotropic Effect of Common Variants at ABO Glycosyltranferase Locus in 9q32 on Plasma Levels of Pancreatic Lipase and Angiotensin Converting Enzyme",
